import 'package:flutter_covid_tracker_app/provider/location.dart';
import 'package:flutter_covid_tracker_app/provider/network_api.dart';
...
class ApiData {
  ...
  Future<dynamic> getStatesData() async {
    NetworkAPI networkAPI =
        NetworkAPI('https://api.rootnet.in/covid19-in/stats/');
